...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function template_tags() : array {
		return [
			...
			'entry_title_header' => [ $this, 'entry_title_header' ],
			'set_entry_title_header' => [ $this, 'set_entry_title_header' ],
			'reset_entry_title_header' => [ $this, 'reset_entry_title_header' ],
		];
	}
	...
	protected function get_google_fonts() : array {
		...
		// Empty because, by default, we don't want to load Google Fonts.
		$google_fonts = [];
